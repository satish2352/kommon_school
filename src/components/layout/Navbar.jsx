      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2 flex-shrink-0">
            {logoUrl ? (
              /* An uploaded logo replaces the icon + wordmark entirely. */
              <img src={logoUrl} alt={brandName} className="h-9 w-auto max-w-[200px] object-contain" />
            ) : (
              <>
                ...
                <div className="leading-tight">
                  <span className="block text-sm font-bold text-gray-900">{brandName}</span>
